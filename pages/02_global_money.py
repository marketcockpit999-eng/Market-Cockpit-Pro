...
# === US M2 Section ===
st.markdown("---")
with st.expander("💵 US Money Supply (M2)", expanded=True):
...
st.markdown("---")
with st.expander(t('central_bank_assets_section'), expanded=True):
...
# === FX Section ===
st.markdown("---")
with st.expander(t('fx_section'), expanded=True):
...
st.markdown("---")
with st.expander(t('global_indices'), expanded=True):
...
# === Commodities Section ===
st.markdown("---")
with st.expander(t('commodities_section'), expanded=True):
...
# === Crypto Section ===
st.markdown("---")
with st.expander(t('crypto_section'), expanded=True):
