...
TRANSLATIONS: Dict[str, Dict[str, str]] = {
    'en': {
        ...
        'liquidity_components': '💧 Liquidity Components (ON RRP / Reserves / TGA)',
        'ff_target_rate': '🎯 FF Target Rate',
...
| **> 1.5** | 🔴 Crisis | Financial crisis level |''',
        ...
        # --- Market Verdict Page ---
        'verdict_title': '⚖️ Market Verdict',
        'verdict_subtitle': 'Integrated market assessment from 4 pillars',
        'verdict_calculating': 'Calculating VERDICT...',
        'verdict_insufficient_data': '⚠️ Insufficient data for VERDICT calculation',
        'verdict_partial_data': 'ℹ️ Partial data available - some pillars may be missing',
        'verdict_four_pillars': '📊 Four Pillars',
        'verdict_detailed_breakdown': '📋 Detailed Breakdown',
        'verdict_gauge_caution': '0 (Caution)',
        'verdict_gauge_neutral': '50 (Neutral)',
        'verdict_gauge_bullish': '100 (Bullish)',
        'verdict_pillar_liquidity': 'Liquidity',
        'verdict_pillar_cycle': 'Cycle',
        'verdict_pillar_technical': 'Technical',
        'verdict_pillar_sentiment': 'Sentiment',
        'verdict_breakdown_liquidity': '💧 Liquidity Breakdown',
        'verdict_breakdown_cycle': '🔄 Cycle Breakdown',
        'verdict_breakdown_technical': '📈 Technical Breakdown',
        'verdict_breakdown_sentiment': '📊 Sentiment Breakdown',
        'verdict_header_indicator': '**Indicator**',
        ...
        'verdict_ind_reserves': 'Reserves',
        'verdict_ind_m2_growth': 'M2 Growth (YoY)',
        'verdict_ind_net_liquidity': 'Net Liquidity',
        'verdict_ind_yield_curve': 'Yield Curve',
        'verdict_ind_unemployment': 'Unemployment Trend',
        'verdict_ind_credit_spread': 'Credit Spread',
        'verdict_ind_leading_index': 'Leading Index',
        'verdict_ind_mfg_composite': 'Manufacturing Composite',
        'verdict_ind_svc_composite': 'Services Composite',
        'verdict_ind_ma_deviation': '200-day MA Deviation',
        'verdict_ind_rsi': 'RSI(14)',
        ...
        'verdict_multi_asset_title': '📊 Multi-Asset VERDICT',
        'verdict_multi_asset_subtitle': 'Which asset class is favored in current environment?',
        'verdict_asset_stock': '📈 Stocks',
        'verdict_asset_gold': '🥇 Gold',
        'verdict_asset_btc': '₿ Bitcoin',
        'verdict_pillar_real_rate': 'Real Rate',
        'verdict_pillar_uncertainty': 'Uncertainty',
        'verdict_pillar_dxy': 'USD Index',
        'verdict_pillar_crypto_sentiment': 'Crypto Sentiment',
        'verdict_ranking_title': '💡 Current Priority',
        ...
        # --- Verdict Interpretation Labels ---
        'verdict_interp_bullish': 'Bullish',
        'verdict_interp_moderately_bullish': 'Moderately Bullish',
        'verdict_interp_neutral': 'Neutral',
        'verdict_interp_caution': 'Caution',
        'verdict_interp_bearish': 'Bearish',
        'verdict_desc_bullish': 'Liquidity, cycle, and technicals align favorably. Risk-on environment.',
        'verdict_desc_moderately_bullish': 'Generally favorable conditions. Growth stocks and cyclicals are reasonable.',
        'verdict_desc_neutral': 'Mixed signals. Selective approach recommended.',
        'verdict_desc_caution': 'Liquidity contraction phase. Consider shift to defensive sectors and commodities.',
        'verdict_desc_bearish': 'Multiple headwinds. Favor cash, short-term bonds, and gold.',
        'verdict_ranking_format': 'Current environment favors: {first} > {second} > {third}',
...
Visualize differences between traditional assets (Gold) and digital assets (BTC).''',
        ...
        # --- Money Flow Page ---
        'page_money_flow': '💰 Money Flow',
        'money_flow_title': '💰 Money Flow Visualization',
        'money_flow_desc': 'Visualize how money flows from the Fed through banks to the economy',
        'money_flow_sankey_title': 'Flow of Money in the US Financial System',
        'money_flow_key_metrics': 'Key Metrics',
        'money_flow_fed_assets': 'Fed Total Assets',
        'money_flow_fed_assets_help': 'Total assets on Fed balance sheet (SOMA)',
        'money_flow_net_liquidity': 'Net Liquidity',
        'money_flow_net_liquidity_help': 'Fed Assets - TGA - RRP = Money available to markets',
        'money_flow_bank_reserves': 'Bank Reserves',
        'money_flow_bank_reserves_help': 'Reserves held by commercial banks at the Fed',
        'money_flow_m2': 'M2 Money Supply',
        'money_flow_m2_help': 'Total money in circulation (cash + deposits)',
        'money_flow_explanation_title': 'How to Read This Chart',
        'money_flow_explanation_expand': 'Click to expand explanation',
        'money_flow_step1_title': 'Step 1: The Fed Creates Money',
        'money_flow_step1_desc': 'When the Fed buys Treasury securities (QE), it creates new money that flows to banks as reserves.',
        'money_flow_step2_title': 'Step 2: Money Gets Absorbed',
        'money_flow_step2_desc': 'TGA (Treasury account) and RRP (Reverse Repo) absorb money from the system, reducing available liquidity.',
        'money_flow_step3_title': 'Step 3: Banks Lend and Invest',
        'money_flow_step3_desc': 'Banks use reserves to make loans (C&I, CRE, Consumer) and buy securities.',
        'money_flow_step4_title': 'Step 4: Money Reaches the Economy',
        'money_flow_step4_desc': 'Through lending and spending, money flows into M2 and financial markets.',
        'money_flow_formula_title': 'Net Liquidity Formula',
        'money_flow_formula': 'Net Liquidity = Fed Assets - TGA - RRP',
        'money_flow_absorption_title': 'Liquidity Absorption Analysis',
        'money_flow_tga_label': 'TGA (Treasury)',
        'money_flow_rrp_label': 'RRP (Reverse Repo)',
        'money_flow_available_label': 'Available Liquidity',
        'money_flow_absorption_chart_title': 'Where Is the Money?',
        'money_flow_absorption_analysis': 'Absorption Analysis',
        'money_flow_total_absorption': 'Total Absorbed',
        'money_flow_of_fed_assets': 'of Fed Assets',
        'money_flow_high_absorption_warning': '⚠️ High absorption rate - Less money available for markets',
        'money_flow_moderate_absorption_info': 'ℹ️ Moderate absorption - Normal range',
        'money_flow_low_absorption_success': '✅ Low absorption - More money flowing to markets',
        'money_flow_footer': '💡 This visualization uses live data from FRED and Yahoo Finance. Arrow thickness represents relative flow magnitude.',
        
        # --- Money Flow Phase 2: Timeline Animation ---
        'money_flow_tab_current': 'Current',
        'money_flow_tab_timeline': 'Timeline Replay',
        'money_flow_timeline_title': 'Time-series Sankey Animation',
        'money_flow_timeline_desc': '💡 Use the slider to see how money flow changed over time. Click Play to auto-advance.',
        'money_flow_select_date': 'Select Date',
        'money_flow_speed': 'Speed',
        'money_flow_play': 'Play',
        'money_flow_playback_complete': '✅ Playback complete!',
        'money_flow_comparison_title': 'Historical Comparison',
        'money_flow_key_events': 'Key Events',
...
- 🟢 **2024**: QT slowdown''',
    ...
    'ja': {
        ...
        'tga': 'TGA',
        'tga_notes': '政府口座',
        'liquidity_components': '💧 流動性構成要素 (ON RRP / Reserves / TGA)',
        'ff_target_rate': '🎯 FF誘導目標金利',
...
伝統資産(Gold)とデジタル資産(BTC)の動きの違いを可視化します。''',
        ...
        # --- Money Flow Page ---
        'page_money_flow': '💰 お金の流れ',
        'money_flow_title': '💰 お金の流れを可視化',
        'money_flow_desc': 'Fed → 銀行 → 市場 → 経済へのお金の流れを可視化',
        'money_flow_sankey_title': '米国金融システムのお金の流れ',
        'money_flow_key_metrics': '主要指標',
        'money_flow_fed_assets': 'Fed総資産',
        'money_flow_fed_assets_help': 'Fedバランスシートの総資産（SOMA）',
        'money_flow_net_liquidity': '純流動性',
        'money_flow_net_liquidity_help': 'Fed資産 - TGA - RRP = 市場に流れるお金',
        'money_flow_bank_reserves': '銀行準備金',
        'money_flow_bank_reserves_help': '商業銀行がFedに預けている準備金',
        'money_flow_m2': 'M2マネーサプライ',
        'money_flow_m2_help': '流通しているお金の総量（現金+預金）',
        'money_flow_explanation_title': 'この図の読み方',
        'money_flow_explanation_expand': 'クリックして解説を表示',
        'money_flow_step1_title': 'ステップ1: Fedがお金を創造',
        'money_flow_step1_desc': 'Fedが国債を購入（QE）すると、新しいお金が創造され、銀行の準備金として流れます。',
        'money_flow_step2_title': 'ステップ2: お金が吸収される',
        'money_flow_step2_desc': 'TGA（財務省口座）とRRP（リバースレポ）がシステムからお金を吸収し、利用可能な流動性が減少します。',
        'money_flow_step3_title': 'ステップ3: 銀行が融資・投資',
        'money_flow_step3_desc': '銀行は準備金を使って融資（C&I、CRE、消費者）や有価証券投資を行います。',
        'money_flow_step4_title': 'ステップ4: お金が経済に到達',
        'money_flow_step4_desc': '融資と支出を通じて、お金はM2と金融市場に流れ込みます。',
        'money_flow_formula_title': '純流動性の計算式',
        'money_flow_formula': '純流動性 = Fed資産 - TGA - RRP',
        'money_flow_absorption_title': '流動性吸収の分析',
        'money_flow_tga_label': 'TGA（財務省）',
        'money_flow_rrp_label': 'RRP（リバースレポ）',
        'money_flow_available_label': '利用可能な流動性',
        'money_flow_absorption_chart_title': 'お金はどこにある？',
        'money_flow_absorption_analysis': '吸収分析',
        'money_flow_total_absorption': '総吸収量',
        'money_flow_of_fed_assets': 'Fed資産の',
        'money_flow_high_absorption_warning': '⚠️ 吸収率が高い - 市場に回るお金が少ない',
        'money_flow_moderate_absorption_info': 'ℹ️ 中程度の吸収 - 正常範囲',
        'money_flow_low_absorption_success': '✅ 吸収率が低い - より多くのお金が市場へ',
        'money_flow_footer': '💡 この図はFREDとYahoo Financeのライブデータを使用しています。矢印の太さは相対的なフローの大きさを表します。',
        
        # --- Error Messages ---
        'data_fetch_failed': 'データを取得できませんでした',
        
        # --- Market Verdict Page ---
        'verdict_title': '⚖️ マーケット総合判定',
        'verdict_subtitle': '4本柱による市場総合判定',
        'verdict_calculating': 'VERDICT計算中...',
        'verdict_insufficient_data': '⚠️ VERDICT算出に必要なデータが不足しています',
        'verdict_partial_data': 'ℹ️ 一部データ欠損あり',
        'verdict_four_pillars': '📊 4本柱スコア',
        'verdict_detailed_breakdown': '📋 詳細内訳',
        'verdict_gauge_caution': '0 (警戒)',
        'verdict_gauge_neutral': '50 (中立)',
        'verdict_gauge_bullish': '100 (強気)',
        'verdict_pillar_liquidity': '流動性',
        'verdict_pillar_cycle': 'サイクル',
        'verdict_pillar_technical': 'テクニカル',
        'verdict_pillar_sentiment': 'センチメント',
        'verdict_breakdown_liquidity': '💧 流動性の内訳',
        'verdict_breakdown_cycle': '🔄 サイクルの内訳',
        'verdict_breakdown_technical': '📈 テクニカルの内訳',
        'verdict_breakdown_sentiment': '📊 センチメントの内訳',
        'verdict_header_indicator': '**指標**',
        ...
        'verdict_ind_on_rrp': 'ON RRP',
        'verdict_ind_reserves': '準備預金',
        'verdict_ind_m2_growth': 'M2成長率(YoY)',
        'verdict_ind_net_liquidity': '純流動性',
        'verdict_ind_yield_curve': 'イールドカーブ',
        'verdict_ind_unemployment': '失業率トレンド',
        'verdict_ind_credit_spread': '信用スプレッド',
        'verdict_ind_leading_index': '先行指標',
        'verdict_ind_mfg_composite': '製造業総合',
        'verdict_ind_svc_composite': 'サービス業総合',
        'verdict_ind_ma_deviation': '200日MA乖離',
        'verdict_ind_rsi': 'RSI(14)',
        ...
        # --- Market Verdict: Multi-Asset (Phase 5) ---
        'verdict_multi_asset_title': '📊 マルチアセット判定',
        'verdict_multi_asset_subtitle': '現環境で有利な資産クラスは？',
        'verdict_asset_stock': '📈 株式',
        'verdict_asset_gold': '🥇 ゴールド',
        'verdict_asset_btc': '₿ ビットコイン',
        'verdict_pillar_real_rate': '実質金利',
        'verdict_pillar_uncertainty': '不確実性',
        'verdict_pillar_dxy': 'ドル指数',
        'verdict_pillar_crypto_sentiment': '暗号資産センチメント',
        'verdict_ranking_title': '💡 現環境での優先度',
        ...
        # --- Verdict Interpretation Labels ---
        'verdict_interp_bullish': '強気',
        'verdict_interp_moderately_bullish': 'やや強気',
        'verdict_interp_neutral': '中立',
        'verdict_interp_caution': '注意',
        'verdict_interp_bearish': '警戒',
        'verdict_desc_bullish': '流動性・サイクル・テクニカルが揃って良好。リスクオン環境。',
        'verdict_desc_moderately_bullish': '概ね良好な環境。グロース株・シクリカルに妥当性。',
        'verdict_desc_neutral': '混在シグナル。選別的な対応を。',
        'verdict_desc_caution': '流動性縮小局面。防御セクター・コモディティへのシフトを検討。',
        'verdict_desc_bearish': '複合的な悪材料。現金・短期債・ゴールド選好。',
        'verdict_ranking_format': '現環境では: {first} > {second} > {third}',
        
        # --- Money Flow Page ---
        'page_money_flow': '💰 マネーフロー',
        'money_flow_title': '💰 マネーフロー可視化',
        'money_flow_desc': 'Fedから銀行、市場、経済へのお金の流れを可視化',
        'money_flow_sankey_title': '米国金融システムにおけるお金の流れ',
        'money_flow_key_metrics': '主要指標',
        'money_flow_fed_assets': 'Fed総資産',
        'money_flow_fed_assets_help': 'Fedバランスシート上の総資産(SOMA)',
        'money_flow_net_liquidity': '純流動性',
        'money_flow_net_liquidity_help': 'Fed資産 - TGA - RRP = 市場に供給可能な資金',
        'money_flow_bank_reserves': '銀行準備金',
        'money_flow_bank_reserves_help': '商業銀行がFedに保有する準備金',
        'money_flow_m2': 'M2マネーサプライ',
        'money_flow_m2_help': '流通する総マネー(現金+預金)',
        'money_flow_explanation_title': 'チャートの見方',
        'money_flow_explanation_expand': 'クリックして説明を展開',
        'money_flow_step1_title': 'ステップ1: Fedがお金を創造',
        'money_flow_step1_desc': 'Fedが国債を買う(QE)と、新しいお金が創造され銀行準備金として流れます。',
        'money_flow_step2_title': 'ステップ2: お金が吸収される',
        'money_flow_step2_desc': 'TGA(財務省口座)とRRP(リバースレポ)がシステムからお金を吸収し、利用可能な流動性を減らします。',
        'money_flow_step3_title': 'ステップ3: 銀行が貸出・投資',
        'money_flow_step3_desc': '銀行は準備金を使って融資(C&I、CRE、消費者)を行い、証券を購入します。',
        'money_flow_step4_title': 'ステップ4: お金が経済に到達',
        'money_flow_step4_desc': '貸出と支出を通じて、お金はM2と金融市場に流れ込みます。',
        'money_flow_formula_title': '純流動性の計算式',
        'money_flow_formula': '純流動性 = Fed資産 - TGA - RRP',
        'money_flow_absorption_title': '流動性吸収分析',
        'money_flow_tga_label': 'TGA(財務省)',
        'money_flow_rrp_label': 'RRP(リバースレポ)',
        'money_flow_available_label': '利用可能な流動性',
        'money_flow_absorption_chart_title': 'お金はどこにあるか？',
        'money_flow_absorption_analysis': '吸収分析',
        'money_flow_total_absorption': '総吸収量',
        'money_flow_of_fed_assets': 'のFed資産',
        'money_flow_high_absorption_warning': '⚠️ 高吸収率 - 市場に流れる資金が少ない',
        'money_flow_moderate_absorption_info': 'ℹ️ 中程度の吸収 - 正常範囲',
        'money_flow_low_absorption_success': '✅ 低吸収 - より多くの資金が市場に流れている',
        'money_flow_footer': '💡 この可視化はFREDとYahoo Financeのライブデータを使用。矢印の太さは相対的な流量を表します。',
        
        # --- Money Flow Phase 2: Timeline Animation ---
        'money_flow_tab_current': '現在',
        'money_flow_tab_timeline': '時系列再生',
        'money_flow_timeline_title': '時系列Sankeyアニメーション',
        'money_flow_timeline_desc': '💡 スライダーで過去のお金の流れの変化を確認。再生ボタンで自動再生。',
        'money_flow_select_date': '日付を選択',
        'money_flow_speed': '速度',
        'money_flow_play': '再生',
        'money_flow_playback_complete': '✅ 再生完了！',
        'money_flow_comparison_title': '過去との比較',
        'money_flow_key_events': '主要イベント',
